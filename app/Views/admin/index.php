                        ...
                        <tbody>
                            ...
                            <?php foreach ($admin as $a) : ?>
                                <tr class="align-middle">
                                    ...
                                    <td>
                                        <a href="/admin/edit/<?= $a['id_admin'] ?>" class="btn text-center yellow-bg text-white fw-bold">
                                            Edit
                                        </a>
                                        <a href="/admin/delete/<?= $a['id_admin'] ?>" class="btn btn-danger text-center fw-bold tampilDeleteAdmin" data-bs-toggle="modal" data-bs-target="#deleteModal" data-id="<?= $a['id_admin'] ?>">
                                            Delete
                                        </a>
                                    </td>
                                </tr>
